---
name: paradigm
description: Use when you need to understand codebase architecture, find cross-system dependencies, trace call graphs, detect remote calls (HTTP, Kafka, gRPC), map database access patterns, or assess the impact of a code change across services. Connects to Paradigm via MCP.
metadata:
  author: Paradigm (useparadigm.app)
  version: 1.0.0
---
...
Paradigm indexes your repository and builds a code graph:
